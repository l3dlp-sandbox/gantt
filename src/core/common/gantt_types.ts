/*
	Right now, this is only an internal file with types. The types added to the Gantt package are located in the _dev/build folder
*/
...
export interface GanttStatic {
	...
	*/
	 ...
	 * @param link the link object
	*/
	addLink(link: SerializedLink | Link): string | number;
	...
	*/
	addTask(task: SerializedTask | Task, parent?: string | number, index?: number): string | number;
...
export type DatastoreItem = Task | Link | Baseline | ResourceItem | ResourceAssignment;
...
*/
/**
 * @deprecated Use SerializedTask | Task instead
*/
export type NewTask = Partial<SerializedTask> | Partial<Task> | string | {}
...
export interface DatastoreMethods {
	...
	*/
	getItem(id: string | number): DatastoreItem | void,
	...
	*/
	updateItem(id: string | number, item?: DatastoreItem): void,
	...
	*/
	addItem(item: any, index?: number): number | string,
